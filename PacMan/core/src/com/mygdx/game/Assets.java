...
public class Assets {
    ...
    public void loadAssets(ScreenManager.ScreenType type) {
        switch (type) {
            case MENU:
                assetManager.load("p_atlas.pack", TextureAtlas.class);
    ...
    public void createStandardFont(int size) {
        ...
        fontParameter.fontFileName = "p_font.ttf";
        ...
        assetManager.load("p_font" + size + ".ttf", BitmapFont.class, fontParameter);
    }

    public void makeLinks() {
        textureAtlas = assetManager.get("p_atlas.pack", TextureAtlas.class);
    }
